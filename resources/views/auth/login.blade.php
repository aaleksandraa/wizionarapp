    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                <input id="remember_me" type="checkbox" class="rounded dark:bg-black border-gray-300 dark:border-gray-700 text-indigo-600 shadow-sm focus:ring-pink-500 dark:focus:ring-indigo-600 dark:focus:ring-offset-gray-800" name="remember">
